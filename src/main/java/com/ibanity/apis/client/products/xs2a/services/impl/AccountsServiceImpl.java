...
public class AccountsServiceImpl implements AccountsService {
    ...
    public Account find(AccountReadQuery accountReadQuery) {
        ...
        ClassicHttpResponse response = ibanityHttpClient.get(buildUri(url), accountReadQuery.getAdditionalHeaders(), accountReadQuery.getCustomerAccessToken());
    ...
    public IbanityCollection<Account> list(AccountsReadQuery accountsReadQuery) {
        ...
        ClassicHttpResponse response = ibanityHttpClient.get(buildUri(url, pagingSpec), accountsReadQuery.getAdditionalHeaders(), accountsReadQuery.getCustomerAccessToken());
    ...
    public Account delete(AccountDeleteQuery accountDeleteQuery) {
        ...
        ClassicHttpResponse response = ibanityHttpClient.delete(buildUri(url), accountDeleteQuery.getAdditionalHeaders(), accountDeleteQuery.getCustomerAccessToken());
        return IbanityModelMapper.mapResource(response, customMappingFunction());
    }
