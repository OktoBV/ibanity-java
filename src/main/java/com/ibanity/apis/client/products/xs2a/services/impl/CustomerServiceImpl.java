...
public class CustomerServiceImpl implements CustomerService {
    ...
    public Customer delete(CustomerDeleteQuery customerDeleteQuery) {
        ...
        ClassicHttpResponse response = ibanityHttpClient.delete(buildUri(url), customerDeleteQuery.getAdditionalHeaders(), customerDeleteQuery.getCustomerAccessToken());
